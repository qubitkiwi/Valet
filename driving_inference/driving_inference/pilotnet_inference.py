...
from .model_pytorch import PilotNet
...
class PilotNetInferenceNode(Node):
    def __init__(self):
        super().__init__('pilotnet_inference_node')
        
        self.declare_parameter('CROP_HEIGHT', 100)
        self.declare_parameter('LEANER_GAIN', 0.8)
        self.declare_parameter('STEERING_GAIN', 1.0)
        self.declare_parameter('MODEL_PATH', 'data_aug_train256_lr001_model.pth')
